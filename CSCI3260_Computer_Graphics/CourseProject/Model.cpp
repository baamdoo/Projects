...
std::vector<MaterialTexture> Model::loadMaterialTextures(aiMaterial* material, aiTextureType type, std::string typeName)
{
	...
	for (unsigned int i = 0; i < material->GetTextureCount(type); i++)
	{
		...
		bool skip = false;
		for (unsigned int j = 0; j < m_TexturesLoaded.size(); i++)
		{
...
void Model::calulateRadius()
{
	float xMax = -1001.0f, yMax = -1001.0f, zMax = -1001.0f;
	float xMin = 1001.0f, yMin = 1001.0f, zMin = 1001.0f;
